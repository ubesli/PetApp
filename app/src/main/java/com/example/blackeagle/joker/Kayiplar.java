...
public class Kayiplar extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kayiplar);
        b = findViewById(R.id.button3);
        liste = findViewById(R.id.kayip_listview);
        checkBox = findViewById(R.id.checkBox);
        mUser = FirebaseAuth.getInstance().getCurrentUser();
        newRef = FirebaseDatabase.getInstance().getReference("Losts");
        ref2 = FirebaseDatabase.getInstance().getReference("Losts");
      ...
      /*  adapter.clear();
        ...
        liste.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intenttt.setClass(Kayiplar.this,KayipGoruntule.class);
                intenttt.putExtra("uniqid","from_activitykayiplar");
    ...
    private void benimilanlarım() {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Losts");
